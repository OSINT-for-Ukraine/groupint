...
| `ATLOS_BASE_URL` | `http://atlos:4000` | Atlos API base (local Docker or `https://platform.atlos.org`) |
| `ATLOS_API_TOKEN` | — | Atlos API export (`core/incidents/atlos_export.py`) |
...
UI settings saved in Neo4j override env/secrets for Atlos API export. See [Atlos export](incidents/atlos-export.md).
